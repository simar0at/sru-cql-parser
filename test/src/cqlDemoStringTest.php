 ...
 */
class CQLParserTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testToCQL() {
        ...
        $this->assertStringEqualsFile('DemoStringToCQL.txt', $out->toCQL());
    }
    ...
    public function testToXCQL() {
        $out = $this->object->query();
        $out->config = $this->config;
        $this->assertXmlStringEqualsXmlFile('DemoStringToXCQL.xml', $out->toXCQL());
    }
